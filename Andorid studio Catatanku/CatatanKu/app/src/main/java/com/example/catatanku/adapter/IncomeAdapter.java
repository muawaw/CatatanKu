...
import com.example.catatanku.Budget;
...
public class IncomeAdapter extends RecyclerView.Adapter<IncomeAdapter.ViewHolder> {
    ...
    public IncomeAdapter(Context context, List<DataModel> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(context, Budget.class);
    ...
    private void deleteData(final DataModel data) {
        String url = "http://"+ EndPoint.BASE_URL+"/catatan/delete_income.php?id="+data.id;
        Log.d("aim","url : "+url);
