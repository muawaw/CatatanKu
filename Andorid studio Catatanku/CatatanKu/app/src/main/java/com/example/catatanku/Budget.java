...
public class Budget extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    private Spinner spin;
    private String[] kategori = {"Uang Jajan", "Uang Penjualan", "Uang Gaji", "Lainnya"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        input.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(Budget.this);
                ...
                dialog.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (input.getText().toString().equals("UPDATE")) {
                            Log.d("aim","update");
                            updateBudget(updateID,spin.getSelectedItem().toString(),Jumlah,tanggal);
                        } else {
                            Log.d("aim","insert");
                            insertBudget(spin.getSelectedItem().toString(),Jumlah,tanggal);
                        }
    ...
    private void insertBudget(String kategori, String jumlah, String tanggal) {
        jumlah = jumlah.replace(",","");
        Log.d("aim","jumlah : "+jumlah);
        String url = "http://"+EndPoint.BASE_URL+"/catatan/add_income.php?kategori="+kategori+"&jumlah="+jumlah+"&tanggal="+tanggal;
    ...
    private void updateBudget(Integer id, String kategori, String jumlah, String tanggal) {
        jumlah = jumlah.replace(",","");
        Log.d("aim","jumlah : "+jumlah);
        String url = "http://"+EndPoint.BASE_URL+"/catatan/update_income.php?id="+id+"&kategori="+kategori+"&jumlah="+jumlah+"&tanggal="+tanggal;
