...
// <alamat ip server>/catatan/add_income.php?id_income=1&kategori=jajan&jumlah=30000&tanggal=2020-05-04
...
if(isset($_GET['kategori']) && isset($_GET['jumlah']) && isset($_GET['tanggal'])){
  ...
  $hasil_query=mysqli_query($connect,"INSERT INTO income(kategori, jumlah, tanggal) VALUES('$kategori','$jumlah','$tanggal')");
  $response = array();
