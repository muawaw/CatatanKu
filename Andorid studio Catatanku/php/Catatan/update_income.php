...
// update field dari table income berdasarkan id income
// <alamat ip server>/catatan/update_income.php?id=1&kategori=jajan&jumlah=30000&tanggal=2020-05-04

// ini file buat mengakses database conn.php
include "conn.php";

// Mengambil parameter yang berasal dari url yang dikirim dari android (id_income, kategori, jumlah, tanggal)
...
if(isset($_GET['id']) && isset($_GET['kategori']) && isset($_GET['jumlah']) && isset($_GET['tanggal'])){
  ...
  $hasil_query=mysqli_query($connect, "UPDATE income SET kategori='$kategori', jumlah='$jumlah', tanggal='$tanggal' WHERE id_income='$id'");
  $response = array();
